  ...
  if (!data) return (
    <div style={{ ...rs, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: mob ? 16 : 32 }}>
      ...
      <div style={{ textAlign: "center", maxWidth: 480, width: "100%", padding: mob ? "0 8px" : 0, boxSizing: "border-box" }}>
        ...
        {/* About section */}
        <div style={{ marginTop: 22, background: K.cd, border: `1px solid ${K.bd}`, borderRadius: 12, padding: "14px 18px", textAlign: "right" }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: K.ad, marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }}>
            <span>ℹ️</span> מה זה Koopax OpenFormat?
          </div>
          <div style={{ fontSize: 11, color: K.tx, lineHeight: 1.75, marginBottom: 10 }}>
            כלי חינמי ופתוח לקריאת קבצי <strong>מבנה אחיד</strong> (הוראה 131 מס הכנסה) — ישירות בדפדפן, ללא העלאת נתונים לשרת.
            תומך בקבצים גדולים מעל 4MB שהסימולטור הרשמי אינו מקבל.
          </div>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
            <button onClick={() => setShowAbout(true)} style={{ fontSize: 11, fontWeight: 600, color: K.ac, background: K.al, border: `1px solid ${K.ac}`, padding: "5px 12px", borderRadius: 7, cursor: "pointer", fontFamily: "inherit" }}>
              קרא עוד
            </button>
            <a
              ...
              style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 11, fontWeight: 600, color: "#fff", background: "#24292f", padding: "5px 12px", borderRadius: 7, textDecoration: "none" }}
            >
              <svg height="13" viewBox="0 0 16 16" width="13" fill="currentColor"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z" /></svg>
              קוד פתוח
            </a>
          </div>
        </div>
